...
To view details about your posture findings:
...
1. In [Zero Trust](https://one.dash.cloudflare.com), go to **CASB** > **Posture**.
2. Find the finding you want to modify and select **Manage**.
...
To view details about your content findings:
...
1. In [Zero Trust](https://one.dash.cloudflare.com), go to **CASB** > **Posture**.
2. Choose **SaaS** or **Cloud**.
3. Find the individual finding, then select **Manage**.
...
1. In [Zero Trust](https://one.dash.cloudflare.com), go to **CASB** > **Posture**.
2. Find the active finding you want to hide.
...
CASB supports creating a Gateway policy with findings from the [Google Workspace integration](/cloudflare-one/applications/scan-apps/casb-integrations/google-workspace/):
